...
# Stop if file is not found 
  ...
  # If you want balanced, it checks that the data is balanced
...
# If the use of 'grocery' bags is 1  make percent plastic bag the same
...
# Create single treatment effect
  ...
  dataMain <- dataMain %>%
    ...
    mutate(
      ...
      firstCS    = if_else(is.na(firstY), 0, firstY + 1) # First cleanyo 
    ) %>%
    ungroup()
