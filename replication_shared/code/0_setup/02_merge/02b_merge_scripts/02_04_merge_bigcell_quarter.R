#############################################################################################
# Bigcell-quarter level final data combination 
...
load('data/processed/00_data_intermediate/00_data_bigcell_quarter.rda')
...
data <- data %>% arrange(groupID1, year, quarter)
...
save(data, file="data/processed/appendix/02_data_merged/02_merged_bigcell_quarter.rda")
