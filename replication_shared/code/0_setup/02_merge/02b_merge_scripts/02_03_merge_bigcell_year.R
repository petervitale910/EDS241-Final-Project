...
load('data/processed/00_data_intermediate/00_data_bigcell_year.rda')
...
save(data, file="data/processed/02_merged_bigcell_year.rda")
save(dataBalanced, file="data/processed/02_merged_bigcell_year_balanced.rda")
